  ...
  return (
    <div className="bg-white border border-black/5 rounded-2xl overflow-hidden">
      <div className="px-6 py-4 border-b border-black/5 bg-black/[0.015]">
        <p className="text-xs text-black/40">Heading and subtext shown on the Resources page</p>
      </div>
      <form
        onSubmit={e => { e.preventDefault(); startTransition(async () => { await saveResources(data); setSaved(true) }) }}
